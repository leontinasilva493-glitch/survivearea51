  ...
  return new ImageResponse(
    <div style={{ width: "100%", height: "100%", display: "flex", position: "relative", overflow: "hidden", background: "#061115", color: "#e7f2ef", padding: "70px", fontFamily: "Arial Narrow, sans-serif" }}>
      ...
      <div style={{ display: "flex", flexDirection: "column", justifyContent: "space-between", position: "relative", width: "72%" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column" }}><div style={{ display: "flex", flexDirection: "column", fontSize: 88, lineHeight: 0.88, letterSpacing: -5, fontWeight: 800 }}><span>SURVIVE VERITY</span><span>IN AREA 51</span></div><div style={{ marginTop: 28, fontSize: 30, color: "#90aaa8" }}>Weapons · Map · Coins · Gamepasses</div></div>
